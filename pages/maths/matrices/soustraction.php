...
<head>
    ...
    <title>Matrice soustraction</title>
</head>
<body>
    <nav>
        <a href="/index.php">Acueil</a>
        <h1>Matrice soustraction</h1>
        <iframe width="640" height="360" src="https://www.youtube.com/embed/vVu_O-Wq_34?si=eQevuQze1zKbfzbJ&amp;start=130" frameborder="0" allowfullscreen></iframe>
    </nav>
    <section>
        <h2>Cours</h2>
        <p>Pour soustraire deux matrices il faut déjà s'assurer qu'elles ont la <strong>même taille</strong> (par exemple 2×2 ou 3×3), <br>
        on soustré les éléments qui <strong>occupent la même position</strong> dans chaque matrice.</p>
        <p>Exemple :</p>
    </section>
    <section>
        <div>
        ...
        <div>
            <form id="reponce2x2" method="post" enctype="multipart/form-data" action="soustraction.php">
            ...
            <form method="post" action="soustraction.php">

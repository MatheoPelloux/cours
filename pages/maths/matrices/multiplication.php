...
<head>
    ...
    <title>Matrice multiplication</title>
</head>
<body>
    <nav>
        <a href="/index.php">Acueil</a>
        <h1>Matrice multiplication</h1>
        <iframe width="640" height="360" src="https://www.youtube.com/embed/ZOtgQxB5NXI?si=d9cGFmnM_phy_1Nr" frameborder="0" allowfullscreen></iframe>
    </nav>
    <section>
        <h2>Cours</h2>
        <p>Pour multiplier deux matrices il faut que, le nombre de <strong>colonnes de la première <br>
        matrice</strong> (A) soit égal au nombre de <strong>ligne de la seconde matrice</strong> (B).<br>
        ..........</p>
        <p>Exemple :</p>
    </section>
    <section>
        ...
        <div>
            <form id="reponce2x2" method="post" enctype="multipart/form-data" action="multiplication.php">
